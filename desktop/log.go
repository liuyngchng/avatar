...
//
// This replaces slog's default TextHandler (which prefixes every field with
// time= / level= / msg=) to keep log lines short and scannable while still
// carrying the level and structured attributes.
package main
